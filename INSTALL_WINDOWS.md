...
The browser talks to CAN hardware through a **local Python WebSocket bridge** (`client/public/pcan_bridge.py`). Node does not start this; run it in a **second** terminal when you need the bridge.
...
Or: `py -3 client\public\pcan_bridge.py`
