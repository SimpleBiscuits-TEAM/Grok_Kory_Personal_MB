...
/** GM / common diesel-only UDS Mode 22-style PIDs (and injector balance bank). */
const DIESEL_OBD_PIDS = new Set<number>([
  0x0549, 0x054a, 0x0564, 0x0565, 0x056c, 0x056d,
  0x0572, 0x0573, 0x0574, 0x0575, 0x0576, 0x057a,
  0x0590, 0x0591,
