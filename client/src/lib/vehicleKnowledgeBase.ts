...
const L5P_PLATFORM: VehiclePlatform = {
  ...
  keySpecs: {
    ...
    'Transmission': 'Allison 10-speed MYC (2020-2023) / Allison 10L1000 (2024+)',
  ...
  diagnosticNotes: [
    ...
    'The 10-speed Allison transmission has different shift adaptation behavior than the 6-speed. TCC slip patterns differ significantly. 2024+ uses the Allison 10L1000.',
    'L5P uses piezo injectors which have faster response times but different failure modes than solenoid injectors. 2024+ has higher-flow injectors.',
