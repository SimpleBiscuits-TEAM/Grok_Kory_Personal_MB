...
const L5P_PLATFORM: VehiclePlatform = {
  ...
  fuelType: 'diesel',
  description: 'The L5P is GM\'s latest Duramax diesel, featuring a new Denso HP4 injection system with piezo injectors, redesigned turbocharger, and advanced emissions controls including SCR with DEF injection.',
  keySpecs: {
    'Horsepower': '445 HP @ 2800 RPM (2020+)',
    'Torque': '910 lb-ft @ 1600 RPM (2020+)',
    'Compression Ratio': '16.0:1',
    'Injection System': 'Denso HP4 Common Rail (piezo injectors)',
  ...
  commonDTCs: [
    { code: 'P0087', description: 'Fuel Rail/System Pressure Too Low', severity: 'critical', commonCauses: ['Weak CP4/HP4 pump', 'Fuel filter restriction', 'Injector leak-back', 'Low fuel supply pressure', 'Air in fuel system'], diagnosticSteps: ['Check fuel filter condition', 'Monitor rail pressure desired vs actual', 'Check fuel supply pressure at CP4 inlet', 'Perform injector balance rate test', 'Check for air leaks in fuel system'] },
  ...
  diagnosticNotes: [
    ...
    'Rail pressure on L5P can reach 29,000 PSI (200 MPa), higher than previous Duramax generations.',
    'The 10-speed Allison 10L1000 transmission has different shift adaptation behavior than the 6-speed. TCC slip patterns differ significantly.',
    'L5P uses piezo injectors which have faster response times but different failure modes than solenoid injectors.',
    'DPF regeneration on L5P occurs approximately every 300-500 miles depending on driving conditions.',
    'The L5P ECM (E92/Bosch MDG1) has enhanced security features that affect tuning access.',
...
const LB7_PLATFORM: VehiclePlatform = {
  ...
  displacement: '6.6L V8 Turbo Diesel',
  fuelType: 'diesel',
  description: 'The original Duramax diesel. The LB7 is known for injector issues but is otherwise a robust platform. No EGR, no DPF, no DEF.',
  keySpecs: {
  ...
  commonDTCs: [
    { code: 'P0087', description: 'Fuel Rail Pressure Too Low', severity: 'critical', commonCauses: ['Injector leak-back (VERY common on LB7)', 'CP3 pump wear', 'Fuel filter'], diagnosticSteps: ['Perform injector return rate test (most important)', 'Check fuel filter', 'Monitor rail pressure'] },
    { code: 'P0201-P0208', description: 'Injector Circuit Malfunction Cyl 1-8', severity: 'critical', commonCauses: ['Injector failure (common LB7 issue)', 'Wiring harness damage', 'ECM driver issue'], diagnosticSteps: ['Check injector resistance', 'Inspect wiring harness routing', 'Test ECM injector drivers'] },
    { code: 'P0380', description: 'Glow Plug Circuit', severity: 'info', commonCauses: ['Failed glow plug', 'Relay'], diagnosticSteps: ['Test glow plugs', 'Check relay'] },
  ],
  specificPIDs: [
    { name: 'Fuel Rail Pressure', hpTunersName: 'Fuel Rail Pressure', efiliveName: 'GM.FRP', units: 'PSI', normalRange: '3000-23200 PSI', description: 'Actual fuel rail pressure', diagnosticRelevance: 'LB7 injector leak-back is the #1 issue. Monitor rail pressure closely.' },
  ...
  diagnosticNotes: [
    ...
    'CP3 pump is generally reliable on the LB7.',
  ],
};
